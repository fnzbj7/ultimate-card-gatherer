var compress_images = require('compress-images'), INPUT_path_to_your_images, OUTPUT_path;
    ...
    INPUT_path_to_your_images = 'f:/Express/usefull_apps/ultimate_card_gatherer/img/ZNR/rename/**/*.{jpg,JPG,jpeg,JPEG,png,svg,gif}';
    OUTPUT_path = 'f:/Express/usefull_apps/ultimate_card_gatherer/img/ZNR/resized/';
